...
int main()
{
    ...
    doublereal temp, h__;
    integer i__;
    doublereal x[11], h[11];
    doublereal fnorm1, fnorm2, wa[130];
    integer lwa;
    extern /* Subroutine */ double bvp_(doublereal *, integer);
    doublereal tol;
...
/* L20: */
  ...
  try
  {
    cout << chabis(makeFunctor((DL2D*)0, bvp_), n, x, h, fvec, 0.1) << endl;
  }
  catch (err_chabis &ex)
  {
...
/* Subroutine */ double bvp_(doublereal *x, integer iflag)
{
    /* System generated locals */
    integer i__1;
...
/* Computing 2nd power */
    d__1 = h__;
    ++refnum_1.nfcall;
    return  x[iflag] * 2. - temp1 - temp2 + temp * (d__1 * d__1);
