<associated_solution class=phase id=test>
  ...
  <internal_solution>
    <SimpleSolution class=phase>
      <components> Bi_g Se_g Bi2_g Bi3_g Bi4_g Se2_g Se3_g Se4_g Se5_g Se6_g Se7_g Se8_g BiSe_g </components>
      <Reference class=FuncTpx>
        <func_x> +x(Bi_g)* </func_x>
        <species id=Bi_g> Bi_g
        ...
        <func_x> +x(Se_g)* </func_x>
        <species id=Se_g> Se_g
          <compound_Tp class=func_Tp>
            <IVT_Tp class=func_Tp>
              (
              <coef> 233135 </coef> +
        ...
        <func_x> +x(Bi2_g)* </func_x>
        <species id=Bi2_g> Bi2_g
          <compound_Tp class=func_Tp>
            <IVT_Tp class=func_Tp>
              (
              <coef> 207362 </coef> +
        ...
        <func_x> +x(Bi3_g)* </func_x>
        <species id=Bi3_g> Bi3_g
          <compound_Tp class=func_Tp>
            <IVT_Tp class=func_Tp>
              (
              <coef> 271073 </coef> +
        ...
        <func_x> +x(Bi4_g)* </func_x>
        <species id=Bi4_g> Bi4_g
          <compound_Tp class=func_Tp>
            <IVT_Tp class=func_Tp>
              (
              <coef> 212114 </coef> +
        ...
        <func_x> +x(Se2_g)* </func_x>
        <species id=Se2_g> Se2_g
          <compound_Tp class=func_Tp>
            <IVT_Tp class=func_Tp>
              (
              <coef> 128689 </coef> +
        ...
        <func_x> +x(Se3_g)* </func_x>
        <species id=Se3_g> Se3_g
          <compound_Tp class=func_Tp>
            <IVT_Tp class=func_Tp>
              (
              <coef> 159789 </coef> +
        ...
        <func_x> +x(Se4_g)* </func_x>
        <species id=Se4_g> Se4_g
          <compound_Tp class=func_Tp>
            <IVT_Tp class=func_Tp>
              (
              <coef> 139606 </coef> +
        ...
        <func_x> +x(Se5_g)* </func_x>
        <species id=Se5_g> Se5_g
          <compound_Tp class=func_Tp>
            <IVT_Tp class=func_Tp>
              (
              <coef> 123067 </coef> +
        ...
        <func_x> +x(Se6_g)* </func_x>
        <species id=Se6_g> Se6_g
          <compound_Tp class=func_Tp>
            <IVT_Tp class=func_Tp>
              (
              <coef> 96728.7 </coef> +
        ...
        <func_x> +x(Se7_g)* </func_x>
        <species id=Se7_g> Se7_g
          <compound_Tp class=func_Tp>
            <IVT_Tp class=func_Tp>
              (
              <coef> 99421.2 </coef> +
        ...
        <func_x> +x(Se8_g)* </func_x>
        <species id=Se8_g> Se8_g
          <compound_Tp class=func_Tp>
            <IVT_Tp class=func_Tp>
              (
              <coef> 100885 </coef> +
        ...
        <func_x> +x(BiSe_g)* </func_x>
        <species id=BiSe_g> BiSe_g
          <compound_Tp class=func_Tp>
            <IVT_Tp class=func_Tp>
              (
              <coef> 162470 </coef> +
      ...
      <IdealMixing class=FuncTpx>
        +R*T*x(Bi_g)*log(x(Bi_g))
        +R*T*x(Se_g)*log(x(Se_g))
        +R*T*x(Bi2_g)*log(x(Bi2_g))
        +R*T*x(Bi3_g)*log(x(Bi3_g))
        +R*T*x(Bi4_g)*log(x(Bi4_g))
        +R*T*x(Se2_g)*log(x(Se2_g))
        +R*T*x(Se3_g)*log(x(Se3_g))
        +R*T*x(Se4_g)*log(x(Se4_g))
        +R*T*x(Se5_g)*log(x(Se5_g))
        +R*T*x(Se6_g)*log(x(Se6_g))
        +R*T*x(Se7_g)*log(x(Se7_g))
        +R*T*x(Se8_g)*log(x(Se8_g))
        +R*T*x(BiSe_g)*log(x(BiSe_g))
      </IdealMixing> 
    </SimpleSolution> 
  </internal_solution>
</associated_solution> 
